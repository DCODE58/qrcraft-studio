-- Enhanced QR Code Platform Schema (Fixed)
...
-- Fix qr_type column: Remove default, change type, set new default
ALTER TABLE public.qr_codes ALTER COLUMN qr_type DROP DEFAULT;
